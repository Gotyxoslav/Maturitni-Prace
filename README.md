...
# Aktivace
1. intall.bat by měl nainstalovat všechny potřebné knihovny, mimo to se dá vše nainstalovat pomocí "pip install Flask argon2-cffi mysql-connector-python pyqt6"
